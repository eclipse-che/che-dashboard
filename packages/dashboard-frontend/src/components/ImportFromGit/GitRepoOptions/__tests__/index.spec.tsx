...
jest.mock('@/components/ImportFromGit/GitRepoOptions/AdditionalGitRemotes');
jest.mock('@/components/ImportFromGit/GitRepoOptions/GitBranchField');
jest.mock('@/components/ImportFromGit/GitRepoOptions/PathToDevfileField');
