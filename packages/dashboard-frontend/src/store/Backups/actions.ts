...
import { BackupConfig, BackupInfo, BackupItem, BackupValidationResult } from '@eclipse-che/common';
 ...
 *
 * Loading: state.backups.loading.isValidating
 *
 * @param namespace - Kubernetes namespace
...
export const validateBackupImage = createAsyncThunk<
  ...
  { namespace: string; imageUrl: string },
  { state: RootState; rejectValue: string }
