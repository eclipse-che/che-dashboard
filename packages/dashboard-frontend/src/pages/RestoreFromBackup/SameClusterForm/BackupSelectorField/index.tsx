...
export class BackupSelectorField extends React.PureComponent<Props, State> {
  ...
  public render() {
    const { backups, selectedBackup, workspaceName } = this.props;
      ...
      <FormGroup fieldId="restore-backup-select" label="Select a backup">
        ...
        {showWarning && (
          <Alert
            ...
            isInline
            title="Workspace is active"
            data-testid="workspace-exists-warning"
          >
            Workspace <strong>{selectedBackup.workspaceName}</strong> still exists on this cluster.
            Provide a different workspace name above, or stop and delete it first.
          </Alert>
        )}
      </FormGroup>
    );
