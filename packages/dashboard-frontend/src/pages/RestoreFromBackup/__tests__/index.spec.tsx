...
describe('RestoreFromBackupPage', () => {
  ...
  describe('default-registry mode', () => {
    ...
    test.skip('should show warning but allow restore when selectedBackup.workspaceExists is true', async () => {
      ...
      // Warning shown in helper text (not as error - restore is still allowed)
      await waitFor(
        () => {
      ...
      // Restore button should NOT be disabled (warning allows restore)
      expect(getRestoreSubmitButton()).not.toBeDisabled();
    });
