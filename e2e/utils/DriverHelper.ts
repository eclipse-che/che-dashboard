...
export class DriverHelper {
    ...
    public async waitVisibilityBoolean(locator: By,
        ...
        polling: number = TestConstants.TEST_DEFAULT_POLLING): Promise<boolean> {
    ...
    public async waitVisibility(elementLocator: By, timeout: number = TestConstants.TEST_DEFAULT_TIMEOUT): Promise<WebElement> {
    ...
    public async waitPresence(elementLocator: By, timeout: number = TestConstants.TEST_DEFAULT_TIMEOUT): Promise<WebElement> {
        const attempts: number = TestConstants.TEST_DEFAULT_ATTEMPTS;
        const polling: number = TestConstants.TEST_DEFAULT_POLLING;
    ...
    public async waitAllPresence(elementLocator: By, timeout: number = TestConstants.TEST_DEFAULT_TIMEOUT): Promise<Array<WebElement>> {
        const attempts: number = TestConstants.TEST_DEFAULT_ATTEMPTS;
        const polling: number = TestConstants.TEST_DEFAULT_POLLING;
    ...
    public async waitAndGetElementAttribute(elementLocator: By,
        attribute: string,
        visibilityTimeout: number = TestConstants.TEST_DEFAULT_TIMEOUT): Promise<string> {
    ...
    public async waitAndGetText(elementLocator: By, timeout: number = TestConstants.TEST_DEFAULT_TIMEOUT): Promise<string> {
        const attempts: number = TestConstants.TEST_DEFAULT_ATTEMPTS;
        const polling: number = TestConstants.TEST_DEFAULT_POLLING;
    ...
    public async waitAndGetValue(elementLocator: By, timeout: number = TestConstants.TEST_DEFAULT_TIMEOUT): Promise<string> {
