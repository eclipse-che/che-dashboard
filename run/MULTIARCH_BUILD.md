...
The `patch.sh` script now supports building Docker images for multiple architectures (AMD64 and ARM64).
...
| `CHE_NAMESPACE` | Kubernetes namespace for Eclipse Che | `eclipse-che` | No |
